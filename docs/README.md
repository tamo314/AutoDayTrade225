...
- 自律継続の現行手順：[128 自律継続](strategy/128_autonomous_orchestration.md)、[129 C01 S1カレンダー検証](strategy/129_c01_s1_calendar_causality.md)、[130 C01 S2入場判定](strategy/130_c01_s2_admission.md)、[131 C01例外レビュー](strategy/131_c01_exception_review.md)、[132 C02出来高入力監査](strategy/132_c02_volume_input_audit.md)
